    ...
    return (
        <AuthenticatedLayout>
            ...
            <PageHeader 
                ...
                action={
                    <Link href={route('products.create')} className="inline-flex items-center justify-center px-10 py-5 bg-brand-dark border border-transparent rounded-full font-black text-[10px] text-white uppercase tracking-[0.2em] hover:bg-black transition shadow-2xl shadow-brand-dark/20 hover:scale-105 active:scale-95">
                        + Add Product
                    </Link>
                }
            />
            ...
            <div className="py-12 px-6 lg:px-12 bg-brand-bg min-h-screen">
                <div className="max-w-[1400px] mx-auto">
                    ...
                    <div className="bg-white rounded-[3rem] shadow-xl shadow-brand-dark/5 border border-brand-tan/10 overflow-hidden">
                            ...
                            <table className="w-full divide-y divide-brand-bg table-fixed">
                                <thead className="bg-brand-bg/30 text-brand-dark">
                                    <tr>
                                        ...
                                        <th className="w-[380px] px-10 py-8 text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">Actions</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr key={product.id} className="hover:bg-brand-bg/10 transition-colors group">
                                            ...
                                            <td className="px-10 py-10 text-right">
                                                <div className="flex items-center justify-end space-x-5 text-brand-dark font-bold uppercase">
                                                    ...
                                                    <div className="flex items-center space-x-2 text-brand-dark font-bold uppercase">
